    ...
    html`
        ...
        <script>
            layui.use(['table', 'treeTable'], function () {
                ...
                let urlTableList = '/admin/api/productCategory/list'
                let urlTableAdd = '/admin/productCategory/add'
                let urlTableEdit = '/admin/productCategory/edit?id='
                let urlTableDelete = '/admin/api/productCategory/delete'
                treeTable.render({
                    elem: '#' + tableElem,
                ...
                treeTable.on('tool(' + tableElem + ')', function (obj) {
                    ...
                    if (layEvent === 'handleClickEdit') {
                        openPage('编辑产品分类', urlTableEdit + trData.id)
