    ...
    html`
        ...
        <script type="text/html" id="honocms-table-toolbar">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm" lay-event="handleClickAdd">添加轮播组</button>
            </div>
        </script>
        ...
        <script>
            layui.use(['table', 'treeTable'], function () {
                ...
                let urlTableList = '/admin/api/adCategory/list'
                let urlTableAdd = '/admin/adCategory/add'
                let urlTableEdit = '/admin/adCategory/edit?id='
                let urlTableDelete = '/admin/api/adCategory/delete'
                treeTable.render({
                    elem: '#' + tableElem,
                ...
                treeTable.on('tool(' + tableElem + ')', function (obj) {
                    ...
                    if (layEvent === 'handleClickEdit') {
                        openPage('编辑轮播组', urlTableEdit + trData.id)
