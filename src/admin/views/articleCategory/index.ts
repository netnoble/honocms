    ...
    html`
        ...
        <script type="text/html" id="honocms-table-toolbar">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm" lay-event="handleClickAdd">添加分类</button>
            </div>
        </script>
        ...
        <script>
            layui.use(['table', 'treeTable'], function () {
                ...
                let urlTableList = '/admin/api/articleCategory/list'
                let urlTableAdd = '/admin/articleCategory/add'
                let urlTableEdit = '/admin/articleCategory/edit?id='
                let urlTableDelete = '/admin/api/articleCategory/delete'
                treeTable.render({
                    elem: '#' + tableElem,
                ...
                treeTable.on('tool(' + tableElem + ')', function (obj) {
                    ...
                    if (layEvent === 'handleClickEdit') {
                        openPage('编辑文章分类', urlTableEdit + trData.id)
