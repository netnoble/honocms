...
<!--                <button class="layui-btn layui-btn-sm" lay-event="handleClickAdd">添加管理员</button>-->
            </div>
        </script>
        <script type="text/html" id="honocms-table-tools">
            <div class="layui-btn-container">
                <a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="handleClickEdit">查看</a>
        ...
        <script>
            layui.use(['table'], function(){
                ...
                let urlTableList = '/admin/api/user/list'
                let urlTableAdd = '/admin/user/add'
                let urlTableEdit = '/admin/user/edit?id='
                let urlTableDelete = '/admin/api/user/delete'
                table.render({
                    elem: '#'+tableElem,
                ...
                table.on('tool('+tableElem+')', function(obj){
                    ...
                    if (layEvent === 'handleClickEdit'){
                        openPage('编辑管理员',urlTableEdit + trData.id)
