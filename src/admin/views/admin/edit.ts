...
export const editView = (c:Context, detailData:any) => {
    ...
    return html`
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="username" lay-verify="required" lay-verType="tips"
                               lay-reqtext="请输入用户名" placeholder="请输入用户名" value="${raw(detailData.username)}" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">密码</label>
                    <div class="layui-input-block">
                        <input type="text" name="password" lay-verType="tips"
        ...
        <script>
            ...
            layui.use(['form'], function () {
                let $ = layui.jquery;
                let form = layui.form;
                let urlCreateItem = '/admin/api/admin/update'
