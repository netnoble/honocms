    ...
    html`
        ...
        <script type="text/html" id="honocms-table-toolbar">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm" lay-event="handleClickAdd">添加文章</button>
            </div>
        </script>
        ...
        <script>
            layui.use(['table'], function(){
                ...
                let urlTableList = '/admin/api/article/list'
                let urlTableAdd = '/admin/article/add'
                let urlTableEdit = '/admin/article/edit?id='
                let urlTableDelete = '/admin/api/article/delete'
                table.render({
                    elem: '#'+tableElem,
                ...
                table.on('tool('+tableElem+')', function(obj){
                    ...
                    if (layEvent === 'handleClickEdit'){
                        openPage('编辑文章',urlTableEdit + trData.id)
